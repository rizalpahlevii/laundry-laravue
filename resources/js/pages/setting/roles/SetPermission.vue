...
export default {
    ...
    methods:{
        // load all function on user module
        ...mapActions('user',[
            'getUserLists',
            'getRoles',
            'getAllPermission',
        ...
        // load mutations from user store
        ...
        // ketika list permission dicentang , maka fungsi ini berjalan
        addPermission(name){
        ...
        // fungsi ini untuk mengambil list permission yang telah di assign ke dalam role yang dipilih
        checkPermission() {
            this.loading = true;
